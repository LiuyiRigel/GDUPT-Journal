...
\caption{图片说明 *字体为小5号，图中的子图要有子图说明*}
\label{fig1}
\end{figure}
...
\vspace {10mm}
\zihao{5}{\noindent \textsf{致\quad 谢}\quad \textit{致谢}}

\vspace {10mm}
\centerline{\zihao{4-}\textsf{[参考文献]}}
\zihao{5-}
...
\zihao{5-}{
\setlength{\baselinestretch}{18pt}\selectfont{
{\bf Abstract:}
...
\vspace {2mm}
{{\bf Keywords:} key word; key word; key word\par}}
