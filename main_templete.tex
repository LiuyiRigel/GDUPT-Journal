...
\headevenname{\mbox{\quad} \hfill  \mbox{\zihao{-5}{ \hfill 《课程名称》  } \hspace {50mm} \mbox{2023 年 9 月}}}%
...
\onecolumn
\zihao{5-}\noindent 作者姓名 等 \hfill 《课程名称 or 报告题目》\hfill 2023 年 9 月\\
...
需要提炼以下内容（参考自饶毅老师）：
\begin{itemize}
    \item What is the major question addressed in this paper?
    \item Is it important or not? And why?
    \item What is the background?
    \item What is the approach?
    \item What is the conclusion(s)?
    \item Is the conclusion supported by the results?
    \item What can be done in the future?
\end{itemize}
...
\textbf{12) 图应为矢量图，或高清图，一般不少于 300dpi。}
...
\begin{figure}[htbp]
\centering
\centerline{\includegraphics[width=0.6\linewidth]{CJC1.pdf}}
...
% {\zihao{5-}*方法过程描述字体为小5号宋体，IF、THEN等伪代码关键词全部用大写字母，变量和函数名称用斜体*}
...
% *算法描述字体为小5号宋体, IF、THEN等伪代码关键词全部用大写字母，变量和函数名称用斜体*}
